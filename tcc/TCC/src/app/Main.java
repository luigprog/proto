...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
     ...
     private void lookadnfeel() {
        if (Universal.plataforma.equalsIgnoreCase("Windows")) {
            try {
                UIManager.setLookAndFeel("com.sun.java.swing.plaf.windows.WindowsLookAndFeel");
                SwingUtilities.updateComponentTreeUI(this);
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(null, "Erro ao configurar look and feel do java.", "Erro", JOptionPane.ERROR_MESSAGE);

            }
        } else if (Universal.plataforma.equalsIgnoreCase("Ubuntu")) {
            try {
