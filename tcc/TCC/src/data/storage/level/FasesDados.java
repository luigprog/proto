...
public class FasesDados {
    ...
    public static void initialize(){
        ...
        fase[1] = new FasesDadosNode(1, "Nessa fase não tem muitos problemas para o Proto enfrentar. Um comando de mover para a direita ja resolve. Proto irá executar o código a cada quadro. É importante que você leia a documentação para aprender todas as funcionalidades de Proto.", true);
        fase[2] = new FasesDadosNode(2, "Proto pode identificar o que tem em um quadro do cenário, escaneando uma posição(x, y). Desse modo, ele pode identificar quando tem um buraco no quadro à frente, por exemplo. Proto também é capaz de pular, driblando assim os buracos. Saiba mais sobre essas funcionalidades na documentação.", true);
        ...
        fase[5] = new FasesDadosNode(5, "Proto pode identificar, subir, e descer escadas. Quando ele sobe, vai até o fim da escada. Ao descer, vai até o fim também. Veja a documentação para mais detalhes. É importante que você teste e treine neste cenário até dominar as escadas, pois será importante mais pra frente.\nDica: Proto tem problemas com escadas. Você deve achar um jeito de sair de perto da escada após subir/descer ela, ou então o robô pode ficar subindo e descendo sem parar.", true);
        fase[6] = new FasesDadosNode(6, "As escadas podem ser diferentes dependendo do tipo de cenário. Nesta fase por exemplo, ele usa rochas empilhadas como escada, o funcionamento é o mesmo. Use o que aprendeu sobre sentidos e escadas, e tente fazer uma boa pontuação.", true);
        fase[7] = new FasesDadosNode(7, "Neste momento, você ja está preparado para ajudar Proto em desafios maiores. Este cenário exige um pouco de tudo que você aprendeu e praticou: saber quando pular, quando pode cair, inteligência para escolher o sentido, subir e descer escadas, pegar esferas em sequência e chegar ao objetivo. Dê o seu melhor!", true);
